# Trust extraction prompt. Assesses whether a facility's CLAIMS are evidence-supported.
# Data-record integrity (duplicate phones, bad location, etc.) is a SEPARATE concern,
# scored in prompts/quality_score.py and written to facilities_quality_scores.
