...
The user copied the prompt for a DevHub **recipe** — **Create a Lakebase Instance** (https://developers.databricks.com/templates/lakebase-create-instance).
...
---
title: "Create a Lakebase Instance"
url: https://developers.databricks.com/templates/lakebase-create-instance
summary: "Provision a managed Lakebase Postgres project on Databricks and collect the connection values needed by downstream templates."
---
