...
The user copied the prompt for a DevHub **recipe** — **Streaming AI Chat with Model Serving** (https://developers.databricks.com/templates/ai-chat-model-serving).
...
---
title: "Streaming AI Chat with Model Serving"
url: https://developers.databricks.com/templates/ai-chat-model-serving
summary: "Build a streaming AI chat experience using AI SDK and Databricks Model Serving endpoints."
---
