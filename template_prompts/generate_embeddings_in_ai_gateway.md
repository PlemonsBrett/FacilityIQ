...
The user copied the prompt for a DevHub **recipe** — **Generate Embeddings with AI Gateway** (https://developers.databricks.com/templates/embeddings-generation).
...
---
title: "Generate Embeddings with AI Gateway"
url: https://developers.databricks.com/templates/embeddings-generation
summary: "Generate text embeddings from a Databricks AI Gateway endpoint using the Databricks SDK."
---
