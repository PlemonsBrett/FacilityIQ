...
The user copied the prompt for a DevHub **example app** — **Inventory Intelligence** (https://developers.databricks.com/templates/inventory-intelligence).
...
```bash
databricks apps init --template https://github.com/databricks/app-templates/tree/main/inventory-intelligence --name <app-name>
```


## Source Code

GitHub: https://github.com/databricks/app-templates/tree/main/inventory-intelligence
