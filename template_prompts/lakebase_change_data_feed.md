...
The user copied the prompt for a DevHub **recipe** — **Lakebase Change Data Feed: Sync Lakebase to Unity Catalog (Autoscaling)** (https://developers.databricks.com/templates/lakebase-change-data-feed-autoscaling).
...
---
title: "Lakebase Change Data Feed: Sync Lakebase to Unity Catalog (Autoscaling)"
url: https://developers.databricks.com/templates/lakebase-change-data-feed-autoscaling
summary: "Replicate Lakebase Autoscaling Postgres tables into Unity Catalog as managed Delta tables using Lakebase Change Data Feed (CDF), with full SCD Type 2 history."
---
