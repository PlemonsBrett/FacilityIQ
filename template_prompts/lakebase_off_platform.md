...
The user copied the prompt for a DevHub **cookbook** — **Lakebase Off-Platform** (https://developers.databricks.com/templates/lakebase-off-platform).
...
url: https://developers.databricks.com/templates/lakebase-off-platform
...
## Component: Lakebase Env Management for Off-Platform Apps
...
## Component: Lakebase Token Management
...
## Component: Drizzle + Lakebase in an Off-Platform App
