...
The user copied the prompt for a DevHub **recipe** — **Lakebase Data Persistence** (https://developers.databricks.com/templates/lakebase-data-persistence).
...
---
title: "Lakebase Data Persistence"
url: https://developers.databricks.com/templates/lakebase-data-persistence
summary: "Add a managed Postgres database to your Databricks app using the Lakebase plugin. Covers schema setup, table creation, and full CRUD REST API routes."
---
