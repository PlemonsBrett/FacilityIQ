...
The user copied the prompt for a DevHub **recipe** — **Lakebase pgvector** (https://developers.databricks.com/templates/lakebase-pgvector).
...
---
title: "Lakebase pgvector"
url: https://developers.databricks.com/templates/lakebase-pgvector
summary: "Enable vector similarity search in Lakebase using the pgvector extension. Covers extension setup, vector table design, insert and cosine retrieval helpers, and IVFFlat/HNSW index options."
---
