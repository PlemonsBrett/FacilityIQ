...
The user copied the prompt for a DevHub **recipe** — **Lakebase Token Management** (https://developers.databricks.com/templates/lakebase-token-management).
...
---
title: "Lakebase Token Management"
url: https://developers.databricks.com/templates/lakebase-token-management
summary: "Implement cached workspace and Lakebase credential token flows for secure Postgres access in off-platform deployments."
---
