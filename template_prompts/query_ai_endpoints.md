...
The user copied the prompt for a DevHub **recipe** — **Query AI Gateway Endpoints** (https://developers.databricks.com/templates/foundation-models-api).
...
---
title: "Query AI Gateway Endpoints"
url: https://developers.databricks.com/templates/foundation-models-api
summary: "Query AI Gateway endpoints for production-ready access to foundation models with built-in governance."
---
