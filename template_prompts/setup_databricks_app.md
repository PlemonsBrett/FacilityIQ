...
The user copied the prompt for a DevHub **recipe** — **Spin Up a Databricks App** (https://developers.databricks.com/templates/spin-up-databricks-app).
...
url: https://developers.databricks.com/templates/spin-up-databricks-app
summary: "Scaffold a fresh AppKit Databricks App with `databricks apps init`, run it locally, and deploy to your workspace."
---
