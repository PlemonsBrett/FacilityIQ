...
The user copied the prompt for a DevHub **recipe** — **Set Up Unity Catalog with External Storage** (https://developers.databricks.com/templates/unity-catalog-setup).
...
---
title: "Set Up Unity Catalog with External Storage"
url: https://developers.databricks.com/templates/unity-catalog-setup
summary: "Create a Unity Catalog catalog backed by an external S3 bucket with storage credentials, external location, and a schema ready for lakehouse tables."
---
