...
The user copied the prompt for a DevHub **recipe** — **Sync Tables: Unity Catalog to Lakebase (Autoscaling)** (https://developers.databricks.com/templates/sync-tables-autoscaling).
...
---
title: "Sync Tables: Unity Catalog to Lakebase (Autoscaling)"
url: https://developers.databricks.com/templates/sync-tables-autoscaling
summary: "Sync Unity Catalog tables into Lakebase Autoscaling Postgres as synced tables for sub-10ms application queries, with snapshot, triggered, or continuous modes."
---
