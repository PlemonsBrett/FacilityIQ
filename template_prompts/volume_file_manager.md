...
The user copied the prompt for a DevHub **recipe** — **Volume File Manager** (https://developers.databricks.com/templates/volume-file-upload).
...
---
title: "Volume File Manager"
url: https://developers.databricks.com/templates/volume-file-upload
summary: "Add file upload, browsing, download, delete, file type validation, and CSV row preview to your Databricks app using Unity Catalog Volumes."
---
